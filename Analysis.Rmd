...
pdf(file=paste0(figdir,"FigureS7.pdf"), height=8, width=8)
densityplot(out)
dev.off()
...
```{r}
pdf(file=paste0(figdir,"FigureS6.pdf"), height=3, width=7)
...
pdf(file=paste0(figdir,"FigureS4.pdf"), width=11, height=8)
...
pdf(file=paste0(figdir,"Figure1.pdf"), width=7, height=4.25)
par(mfrow=c(1,2))
...
pdf(file=paste0(figdir,"Figure2a.pdf"), height=4, width=6)
...
pdf(file=paste0(figdir,"Figure2b.pdf"), height=4, width=6)
...
pdf(file=paste0(figdir,"Figure3ad.pdf"), height=7, width=7)
...
pdf(file=paste0(figdir,"FigureS3.pdf"),height=2.5,width=4)
print(ggQ.dens)
print(ggK.dens)
print(ggS.dens)
dev.off()
...
pdf(file=paste0(figdir,"Figure3be.pdf"), height=7, width=7)
make_plots(df.scale, mins, maxs)
dev.off()

pdf(file=paste0(figdir,"FigureS1abcd.pdf"), height=7, width=7)
...
pdf(file=paste0(figdir,"FigureS1e.pdf"), height=7, width=7)
ggplot()+
...
pdf(file=paste0(figdir,"Figure3c.pdf"), height=4, width=3)
print(ggplot()+
...
#plot range summaries for lldf.avg, lldf.DOC.low, lldf.DOC.high
point <- cbind(lldf.avg$qmax.g.kg,
               lldf.avg$k.L.mg,
               lldf.avg$tot.soc.kg.m3
               )

#plot range summaries for df.scale, df.lowDOC, df.highDOC
...
pdf(file=paste0(figdir,"FigureS2ab.pdf"), width=6, height=3.5)
...
pdf(file=paste0(figdir,"FigureS2ab_inset.pdf"), width=4, height=1.5)
